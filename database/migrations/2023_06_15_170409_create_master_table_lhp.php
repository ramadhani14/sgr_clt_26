...
class CreateMasterTableLhp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_table_lhp', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('jabatan_pj_saat_ini')->nullable();
            $table->string('catatan')->nullable();
            $table->string('no_sktjm')->nullable();
            $table->decimal('update_tl',17,2)->nullable();
            $table->decimal('sisa_temuan',17,2)->nullable();
            $table->string('kategori')->nullable();
            $table->string('jenis_audit')->nullable();
            $table->string('ketua_tim')->nullable();
            $table->string('no_lhp')->nullable();
            $table->string('tgl_lhp')->nullable();
    ...
    {
        Schema::dropIfExists('master_table_lhp');
    }
}
